      ...
      <div class="cvch">
        <ion-list lines="full" class="ion-no-margin">
          <div v-if="halamanRegister">
            <ion-item>
              <ion-label class="centercs mbcs">List Panel</ion-label>
            </ion-item>
            <ion-item>
              <ion-label position="fixed">Email</ion-label>
              <ion-input placeholder="Input Your Email" type="text" v-model="email" autocomplete="off"></ion-input>
            </ion-item>
            <ion-item>
...
import { IonPage, IonContent, IonList, IonItem, IonLabel, IonInput, IonButton, alertController, useBackButton } from '@ionic/vue';
